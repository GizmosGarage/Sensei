...
- Independent local-model review reduces generation errors but does not provide formal scientific proof; the UI and documentation must not overstate that assurance.
